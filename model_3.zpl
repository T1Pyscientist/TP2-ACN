...
minimize fobj: sum <p> in P: sum <i> in I: (370 * X[i, p] + 540 * T[i, p]);
...
subto terc_max_total: forall <i> in I: sum <p> in P: T[i, p] <= 200;    # Cantidad maxima que se puede tercerizar